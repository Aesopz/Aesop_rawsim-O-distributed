...
namespace RAWSimO.Core.IO
{
    ...
    /// </summary>
    /// <summary>
    /// Energy model physical parameters embedded in the xinst file.
    /// All fields have defaults matching Rizqi et al. so existing xinst files remain valid.
    /// </summary>
    public class DTOEnergyParameters
    {
        /// <summary>AGV empty chassis mass [kg]. Default: 300.</summary>
        public double RobotMass = 300.0;
        /// <summary>AGV body width [m]. Default: 0.6.</summary>
        public double RobotWidth = 0.6;
        /// <summary>AGV body length [m]. Default: 0.75.</summary>
        public double RobotLength = 0.75;
        /// <summary>Rolling friction coefficient. Default: 0.02.</summary>
        public double RollingFriction = 0.02;
        /// <summary>Drivetrain inertia equivalent coefficient. Default: 0.15.</summary>
    ...
    public class DTOInstance : IDataTransferObject<Instance, DTOInstance>
    {
        ...
        /// <summary>
        /// Energy model parameters. Optional — defaults to Rizqi et al. values if absent.
        /// </summary>
